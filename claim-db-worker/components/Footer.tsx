...
export function Footer() {
  return (
    <footer className="w-full box-border overflow-hidden mt-32 md:mt-auto mb-8">
      <div className="max-w-7xl w-full mx-auto flex justify-between items-center flex-col text-center gap-6 sm:flex-row sm:gap-0 px-4">
        ...
        <div className="flex gap-4 md:gap-5 sm:gap-4">
          ...
          <a href="https://pris.ly/x" target="_blank" rel="noopener noreferrer">
            <Image
              src="/xtwitter.svg"
              height={30}
              width={30}
      ...
      <div className="max-w-7xl w-full mx-auto flex justify-between items-center mt-8 pt-8 border-t border-[#2D3748] flex-col text-center gap-6 sm:flex-row sm:gap-0 sm:mt-6 sm:pt-6 px-4">
